 ...
 * |--------+------+------+------+------+------|------.           .------|------+------+------+------+------+--------|
 * |Ctrl/ESC|   A  |   S  |  D   |   F  |   G  | RMB  |           |      |   H  |   J  |   K  |   L  | + *  | DE/# ' |
 * |--------+------+------+------+------+------|------|           |------|------+------+------+------+------+--------|
 * | LShift |   Y  |   X  |   C  |   V  |   B  | LMB  |           |      |   N  |   M  | ,  ; | . :  | -  _ | RShift |
 * `--------+------+------+------+------+-------------'           `-------------+------+------+------+------+--------'
 *                    .----------.   .-------.                                 .------.   .-----.
...
[BASE] = LAYOUT_gergo(
    ...
    MT(MOD_LCTL, KC_ESC),   KC_A,  KC_S,   KC_D,   KC_F, KC_G, KC_BTN2,                       _______,  KC_H,    KC_J, KC_K,     KC_L,   DE_PLUS, LT(DEAD, DE_HASH),
    KC_LSFT,                DE_Y,  KC_X,   KC_C,   KC_V, KC_B, KC_BTN1, KC_PGDN,     KC_DEL,  KC_BSPC,  KC_N,    KC_M, DE_COMM,  DE_DOT, DE_MINS, KC_RSFT,
  MT(MOD_LALT, KC_TAB), MT(MOD_LGUI, KC_SPC), LT(SYMB, KC_ENT), LT(NUMB, KC_ESC),    LT(NUMB, KC_INS),  LT(SYMB, KC_ENT), KC_SPC, KC_TAB
    ),
